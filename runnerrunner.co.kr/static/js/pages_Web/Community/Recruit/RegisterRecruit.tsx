...
const RegisterRecruit = ({
  ...
  const handleSubmit = () => {
    ...
    if (mode === "edit") {
      ...
      promise = jobUpdate(data);
    } else {
      promise = jobRegister(data);
    }
  ...
  useEffect(() => {
    ...
    if (cafeNameInput && cafe) {
      (cafeNameInput as HTMLInputElement).value = cafe.cafeName;
    }
    const cafeAddressInput = document.getElementById("cafeAddress");
    if (cafeAddressInput) {
      (cafeAddressInput as HTMLInputElement).value = cafe
        ? cafe.newAddress
        : "";
    }
  }, [cafe]);
        ...
        <div className="inner">
          <div className="content">
            <InputBoxWrapper>
              ...
              <div className="badge-pc">제휴 신청</div>
            </InputBoxWrapper>
            <InputBoxWrapper>
              <div className="title-wrapper">
